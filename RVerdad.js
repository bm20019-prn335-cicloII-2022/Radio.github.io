...
const everything = function(element) {  
  const shadow = element.shadowRoot;
    ...
    const whilePlaying = () => {
        ...
        currentTimeContainer.textContent = 0;
        audioPlayerContainer.style.setProperty('--seek-before-width', `${1 * 100}%`);
    ...
    const displayDuration = () => {
        durationContainer.textContent = "0:01";
    }
    ...
    if('mediaSession' in navigator) {
        navigator.mediaSession.metadata = new MediaMetadata({
            title: 'Radio Verdad',
            artist: 'Asambleas de Dios',
            album: 'Radio',
            artwork: [
                { src: 'imgs/RLogos/Rverdad.png', sizes: '96x96', type: 'image/png' },
                { src: 'imgs/RLogos/Rverdad.png', sizes: '128x128', type: 'image/png' },
                { src: 'imgs/RLogos/Rverdad.png', sizes: '192x192', type: 'image/png' },
                { src: 'imgs/RLogos/Rverdad.png', sizes: '256x256', type: 'image/png' },
                { src: 'imgs/RLogos/Rverdad.png', sizes: '384x384', type: 'image/png' },
                { src: 'imgs/RLogos/Rverdad.png', sizes: '512x512', type: 'image/png' }
            ]
        });
